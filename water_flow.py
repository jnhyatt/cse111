# To exceed requirements, I added constants for common values used in the calculations.
...
def pressure_gain_from_water_height(height):
    pressure = WATER_DENSITY * EARTH_ACCELERATION_OF_GRAVITY * height  # Pa
...
def pressure_loss_from_fittings(fluid_velocity, quantity_fittings):
    return -0.04 * WATER_DENSITY * fluid_velocity**2 * quantity_fittings / 2000.0
...
def pressure_loss_from_pipe_reduction(
    ...
    k = (0.1 + 50.0 / reynolds_number) * ((larger_diameter / smaller_diameter) ** 4 - 1)
